  ...
  <div class="dash-globalposts">
    ...
    <div v-for="post in userdata" :key="post.id" class="dash-post">
      <div class="dash-user-post">
        ...
        <div class="dash-post-opts">
          ...
          <div class="dash-pop-delete" v-if="openOptionsFor === post.id">
            <button type="button" @click="deletePost(post.id, 'my-posts')">
              Delete
            </button>
      ...
      <div class="dash-options-post">
        ...
        <button
          type="button"
          @click="likePost(post.id, 'my-posts')"
      ...
      <div
        ...
        v-if="openCommentPostId === post.id && (post._count.comments ?? 0) > 0"
      >
        <div v-for="comment in post.comments" :key="comment.createdAt">
          ...
          <div v-if="editingCommentId === comment.id" class="dash-edit-comment">
      ...
      <div class="dash-new-comment-post" v-if="openCommentPostId === post.id">
        <input
          type="text"
          name="post-comment"
          id="post-comment"
          ...
          v-model="postComment"
        />
        <button type="button" @click="newComment(post.id)">
          Post
        </button>
      </div>
      <div
      ...
      >
        ...
        <div class="edit-post">
          ...
          <div class="edit-actions">
            ...
            <button type="button" @click="saveEdit('my-posts')">Save</button>
          </div>
        </div>
      </div>
    </div>
